...
UDPPort=${GAME_UDP_PORT}

# Reset ID determines if the server has undergone a soft-reset. If this number does match the client, the client must create a new character. Used in conjunction with PlayerServerID. It is strongly advised that you backup these IDs somewhere Min: 0 Max: 2147483647 Default: 249142402
ResetID=5968559
...
# WARNING: Server player counts above 32 will potentially result in poor map streaming and desync. Please advance with caution. Min: 1 Max: 254 Default: 32
...
DiscordChatChannel=${DISCORD_CHAT_CHANNEL}

# The Discord logs channel name
DiscordLogChannel=${DISCORD_LOG_CHANNEL}

# The Discord commands channel name
DiscordCommandChannel=${DISCORD_COMMAND_CHANNEL}
...
DisableSafehouseWhenOwnerConnected=false
...
# Disables player anti-cheat protection.
AntiCheatPlayer=2
