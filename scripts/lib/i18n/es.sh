...
MSG[rclone.already]="rclone %s ya esta instalado"
MSG[rclone.need_root]="correlo con sudo: instala un paquete del sistema"
MSG[rclone.downloading]="bajando %s"
MSG[rclone.installed]="instalado: %s"
