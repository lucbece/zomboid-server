...
EJEMPLO_ASK_SSH_LINE='from="203.0.113.10",command="/opt/zomboid-server/scripts/ask.sh --read",restrict ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEJEMPLOEJEMPLOEJEMPLOEJEMPLOEJEMPLO bot'
